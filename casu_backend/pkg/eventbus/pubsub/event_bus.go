...
//	"github.com/hsynrtn/dashboard-management/src/models"
//	pb "github.com/hsynrtn/dashboard-management/src/server/genproto"
//	"reflect"
//	"sync"
//	"time"
//)
...
//func New(handlerTimeout time.Duration, pubsub pb.PubSubClient) eventbus.EventBus {
//	return &eventBus{
...
//	stream, err := b.pubsub.Subscribe(ctx, &models.SubscribeRequest{
//		Topic: eventType,
//	})
//	if err != nil {
...
//
//	if _, err := b.pubsub.Publish(ctx, &models.PublishRequest{
//		Topic:   event.Type,
//		Payload: payload,
//	}); err != nil {
//		return apperrors.Wrap(err)
